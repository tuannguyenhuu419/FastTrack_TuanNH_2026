CLASS zcl_booking_data_generate_t35 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_booking_data_generate_t35 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DELETE FROM zstatus_T35.
    DELETE FROM zcustomer_T35.
    DELETE FROM zbooking_T35.
    DELETE FROM zbkitem_T35.
    ...
    "============================================================
    MODIFY zstatus_T35 FROM TABLE @( VALUE #(
    ...
    "============================================================
    MODIFY zcustomer_T35 FROM TABLE @( VALUE #(
    ...
    "============================================================
    MODIFY zbooking_T35 FROM TABLE @( VALUE #(
    ...
    "============================================================
    MODIFY zbkitem_T35 FROM TABLE @( VALUE #(
      quantity_unit = 'EA'
    ...
    out->write( 'Demo data ready. Open ZI_BOOKING_T35 > Data Preview (F8) to verify.' ).
